!(function (t, s) {
    ...
    function t(t, s) {
        ...
        for (
            var i,
                a = Object.keys(t),
                h = s.toLowerCase().replace(dt, ''),
                e = -1;
            ++e < a.length;

        )
            if (((i = a[e]), i.toLowerCase().replace(dt, '') === h))
                return t[i];
    }
    function s(t) {
    ...
    function r(t) {
        ...
        'GEOGCS' === t.type && (i = t),
            i &&
                ...
                i.DATUM &&
                    i.DATUM.TOWGS84 &&
                    (t.datum_params = i.DATUM.TOWGS84),
        ...
        if ('object' == typeof a) {
            ...
            if (h) {
                ...
                var n = x(a.a, a.b, a.rf, a.ellps, a.sphere),
                    ...
                    o =
                        a.datum ||
                        v(a.datumCode, a.datum_params, n.a, n.b, r.es, r.ep2);
                Nt(this, a),
                    Nt(this, h),
                    (this.a = n.a),
                    (this.b = n.b),
    ...
    function S(t, s, i) {
        ...
        return (
            ...
            'longlat' === t.projName
                ? (i = { x: i.x * lt, y: i.y * lt })
                : (t.to_meter &&
                      (i = { x: i.x * t.to_meter, y: i.y * t.to_meter }),
                  (i = t.inverse(i))),
            ...
            'longlat' === s.projName
                ...
                : ((i = s.forward(i)),
                  s.to_meter &&
                      (i = { x: i.x / s.to_meter, y: i.y / s.to_meter })),
    ...
    function k(t, s, i) {
        ...
        return Array.isArray(i)
            ? ((a = S(t, s, i)), 3 === i.length ? [a.x, a.y, a.z] : [a.x, a.y])
            : ((h = S(t, s, i)),
    ...
    function Q(t) {
        ...
        a = t.substring(e, (e += 2));
        for (
            var o = U(n), l = W(a.charAt(0), o), M = H(a.charAt(1), o);
            M < K(r);
    ...
    function H(t, s) {
        ...
        for (
            var i = Xt.charCodeAt(s - 1), a = 0, h = !1;
            i !== t.charCodeAt(0);
    ...
    var ss = 0.01068115234375,
        is = function (t) {
            var s = [];
            (s[0] =
                1 - t * (0.25 + t * (0.046875 + t * (0.01953125 + t * ss)))),
                (s[1] =
                    t * (0.75 - t * (0.046875 + t * (0.01953125 + t * ss))));
            var i = t * t;
            return (
                (s[2] =
                    i *
        ...
        ps = function (t, s) {
            if (void 0 === t) {
                if (
                    (t = Math.floor((30 * (qt(s) + Math.PI)) / Math.PI) + 1) < 0
                )
                    return 0;
                if (t > 60) return 60;
            }
            ...
            inverse: function (t) {
                for (
                    ...
                    ((i =
                        2 *
                            Math.atan(
                                a * ys(this.e * Math.sin(t.y), -0.5 * this.e),
                            ) -
                        ht),
                ...
                (this.coslat0 = Math.cos(this.lat0)),
                    ...
                    this.sphere
                        ? 1 === this.k0 &&
                          ...
                          (this.k0 =
                              0.5 * (1 + kt(this.lat0) * Math.sin(this.lat_ts)))
                        : (Math.abs(this.coslat0) <= ot &&
                              (this.lat0 > 0
                                  ? (this.con = 1)
                                  : (this.con = -1)),
        ...
        As = {
            ...
            inverse: function (t) {
                ...
                return (
                    (e = qt(o / this.ns + this.long0)), (t.x = e), (t.y = h), t
                );
            },
            names: [
        ...
        Rs = {
            init: function () {
                this.sphere ||
                    ...
                    (this.ml0 =
                        this.a *
                        Es(this.e0, this.e1, this.e2, this.e3, this.lat0)));
            },
            forward: function (t) {
                var s,
                    i,
            ...
            inverse: function (t) {
                ...
                if (this.sphere) {
                    ...
                    switch (
                        ...
                        case this.EQUIT:
                            (i =
                                Math.abs(M) <= ot ? 0 : Math.asin((l * u) / M)),
                                (o *= u),
                                (l = c * M);
                            break;
                        case this.OBLIQ:
                ...
                if (((a = t.x - this.x0), (h = t.y - this.y0), this.sphere))
                    ...
                    for (e = Js; e; --e)
                        if (
                            ...
                            (u =
                                this.a *
                                Es(this.e0, this.e1, this.e2, this.e3, o)),
                            (f =
                                this.e0 -
                        ...
                        : ((s = Math.sqrt(t.x * t.x + t.y * t.y)),
                          ...
                          (p = Math.asin(
                              this.sin_p12 * Math.cos(b) +
                                  this.cos_p12 * Math.sin(b) * y,
                          )),
                          (e = qt(
                              this.long0 +
                                  Math.asin(
                                      (Math.sin(d) * Math.sin(b)) / Math.cos(p),
                                  ),
                          )),
                          (n = Math.atan(
                              ((1 -
                                  (this.es * w * this.sin_p12) / Math.sin(p)) *
                                  Math.tan(p)) /
                                  (1 - this.es),
                          )),
                          (t.x = e),
        ...
        oi = {
            ...
            forward: function (t) {
                ...
                return (
                    (n = Math.atan(
                        (12 / ft) *
                            (a + Math.acos(Math.sin(a) * Math.cos(ct)) - ht),
                    )),
                    (e = Math.sqrt(
                        (1 - Math.cos(h)) /
            ...
            inverse: function (t) {
                ...
                if (0 !== this.es) {
                    ...
                    (p = M.phi < 0 ? 1 : 0),
                        ...
                        (y =
                            this.b /
                            Math.sqrt(d * d + this.one_minus_f_squared)),
                        (M.phi = Math.atan(
                            Math.sqrt(this.a * this.a - y * y) /
                                (this.one_minus_f * y),
                        )),
                        p && (M.phi = -M.phi);
                }
