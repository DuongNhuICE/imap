    ...
    var LayerSwitcher = (function (_Control) {
        ...
        function LayerSwitcher(opt_options) {
            ...
            var _this = possibleConstructorReturn(
                this,
                (
                    LayerSwitcher.__proto__ ||
                    Object.getPrototypeOf(LayerSwitcher)
                ).call(this, { element: element, target: options.target }),
            );

            _this.groupSelectStyle = LayerSwitcher.getGroupSelectStyle(
            ...
            [
                {
                    ...
                    value: function setMap(map) {
                        ...
                        get(
                            LayerSwitcher.prototype.__proto__ ||
                                Object.getPrototypeOf(LayerSwitcher.prototype),
                            'setMap',
                            this,
                        ).call(this, map);
                        if (map) {
            ...
            [
                {
                    ...
                    value: function renderPanel(map, panel, options) {
                        ...
                        options.groupSelectStyle =
                            LayerSwitcher.getGroupSelectStyle(
                                options.groupSelectStyle,
                            );
                        ...
                        LayerSwitcher.forEachRecursive(
                            map,
                            function (l, idx, a) {
                ...
                },
                {
                    ...
                    value: function setGroupVisibility(map) {
                        ...
                        var groups = LayerSwitcher.getGroupsAndLayers(
                            map,
                            function (l) {
                                return (
                                    l.getLayers &&
                        ...
                        groups.forEach(function (group) {
                            ...
                            var descendantVisibility = group
                                .getLayersArray()
                                .map(function (l) {
                        ...
                        groups.forEach(function (group) {
                            ...
                            group
                                ...
                                .forEach(function (l) {
                                    ...
                                    l.set('indeterminate', false);
                                    if (
                                        (!groupVisible || groupIndeterminate) &&
                                        l.getVisible()
                                    ) {
                ...
                },
                {
                    ...
                    value: function renderLayer_(
                        ...
                        if (lyr.getLayers && !lyr.get('combine')) {
                            ...
                            if (
                                rsl > lyr.getMaxResolution() ||
                                rsl < lyr.getMinResolution()
                            ) {
                ...
                },
                {
                    ...
                    value: function getGroupSelectStyle(groupSelectStyle) {
                        return ['none', 'children', 'group'].indexOf(
                            groupSelectStyle,
                        ) >= 0
                            ? groupSelectStyle
                            : 'children';
