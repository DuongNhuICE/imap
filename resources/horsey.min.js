    ...
    })(
        {
                ...
                function (e, t) {
                    ...
                    function o(e) {
                        ...
                        function n(t, n) {
                            ...
                            var i = t.query,
                                a = t.limit;
                            if (!r.blankSearch && 0 === i.length)
                                return void n(null, [], !0);
                    ...
                    function i(e) {
                        ...
                        function E(e, t) {
                            if (pt.anchor) {
                                var n = (
                                    I()
                                        ? Jt.filterAnchoredText
                                        : Jt.filterAnchoredHTML
                                )(e, t);
                        ...
                        function q(e) {
                            W(),
                                e &&
                                    ((Pt = e),
                                    (Pt.className += ' sey-selected'));
                        }
                        function W() {
                            Pt &&
                                ((Pt.className = Pt.className.replace(
                                    / sey-selected/g,
                                    '',
                                )),
                                (Pt = null));
                        ...
                        function F() {
                            Bt.sleep(),
                                (It.className = It.className.replace(
                                    / sey-show/g,
                                    '',
                                )),
                                W(),
                        ...
                        function Y() {
                            function e() {
                                for (var e = Mt.firstChild, n = 0; e; ) {
                                    var r = dt(e),
                                        o = t(r);
                                    0 === o
                                        ? e.classList.add('sey-hide')
                                        : e.classList.remove('sey-hide'),
                                        (n += o),
                                        (e = e.nextSibling);
                                }
                                return n;
                            ...
                            if (H()) {
                                Yt(!0),
                                    C['default'].fabricate(qt, 'horsey-filter');
                                var n = d();
                            ...
                            Bt && (Bt.destroy(), (Bt = null)),
                                ...
                                Ft
                                    ? (C['default'][t](qt, 'keypress', J),
                                      ...
                                      pt.autoHideOnBlur &&
                                          C['default'][t](qt, 'keydown', Z))
                                    : (C['default'][t](qt, 'click', P),
                                      C['default'][t](M, 'keydown', X)),
                                pt.autoHideOnClick &&
                                    C['default'][t](j, 'click', et),
                        ...
                        function ft(t) {
                            var n = e.value,
                                ...
                                a = n.substr(
                                    o.start + o.text.length + (r.end - r.start),
                                ),
                                u = i + t + ' ';
                            (e.value = u + a),
                                p['default'](e, {
                        ...
                        var ht =
                            ...
                            Kt = pt.debounce || 300,
                            Yt = N['default'](o, Kt);
                        void 0 === pt.autoHideOnBlur &&
                            (pt.autoHideOnBlur = !0),
                            void 0 === pt.autoHideOnClick &&
                                (pt.autoHideOnClick = !0),
                ...
                function (e, t) {
                    ...
                    function n(e, t, n) {
                        ...
                        function l(n) {
                            ...
                            if (y && !n)
                                return (g.sleeping = !1), void y.refresh();
                            var r = c(n);
                            y || t === e || (r.y += t.offsetHeight);
                            var o = d.context;
                            (e.style.left = r.x + 'px'),
                                (e.style.top =
                                    (o ? o.offsetHeight : r.y) + 'px');
                        }
                        function s() {
                            y && y.destroy(),
                                r.remove(window, 'resize', v),
                                (p = !0);
                        }
                        var d = n,
                            h = t && t.tagName;
                        h || 2 !== arguments.length || (d = t),
                            h || (t = e),
                            d || (d = {});
                        var p = !1,
                            v = o(l, 30),
                ...
                function (e, t) {
                    (function (n) {
                        ...
                        var o = e('sell'),
                            ...
                            s = document,
                            d =
                                null !== l.mozInnerScreenX &&
                                void 0 !== l.mozInnerScreenX;
                        t.exports = r;
                    }).call(
                        this,
                        'undefined' != typeof global
                    ...
                    function n(e, t, n) {
                        function f(t) {
                            var n = m,
                                r = b;
                            return (
                                (m = b = void 0), (S = t), (x = e.apply(r, n))
                            );
                        }
                        function l(e) {
                            return (
                                (S = e), (C = setTimeout(h, t)), E ? f(e) : x
                            );
                        }
                        function s(e) {
                            var n = e - T,
                            ...
                            if (
                                ...
                                if (l(t)) s(e, t);
                                    ...
                                    for (var n, r = 0; r < e.rangeCount; ++r)
                                        (n = m.createRange()),
                                            n.selectNode(t.item(r)),
                                            e._ranges.push(n);
                                    (e.isCollapsed =
                                        1 === e.rangeCount &&
                                        e._ranges[0].collapsed),
            ...
            29: [
                function (e, t) {
                    ...
                    function a(e, t) {
                        (e.selectionStart = c(e, t.start)),
                            (e.selectionEnd = c(e, t.end));
                    }
                    function u(e, t) {
