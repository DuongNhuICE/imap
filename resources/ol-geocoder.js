...
!(function (t, e) {
    ...
    function P(t, e, n) {
        if (Array.isArray(t))
            ...
            for (
                var s = Array.isArray(e) ? e : e.split(/\s+/), r = s.length;
                r--;
    ...
    (V.prototype.getParameters = function (t) {
        return {
            ...
            params: {
                ...
                limit: t.limit || this.settings.params.limit,
                countrycodes:
                    t.countrycodes || this.settings.params.countrycodes,
                'accept-language':
                    t.lang || this.settings.params['accept-language'],
            },
        };
    }),
    ...
    return (
            ...
            this.els.input.addEventListener(
                        ...
                        e.length
                            ...
                            r.options.autoComplete &&
                                ...
                                (n = setTimeout(function () {
                                    e.length >=
                                        r.options.autoCompleteMinLength &&
                                        r.query(e);
                                }, 200)));
                    },
                    !1,
                ...
                this.options.targetType === v &&
                    this.els.button.addEventListener(
                        ...
                        function (t) {
                            t.stopPropagation(),
                                N(r.els.control, H.glass.expanded)
                                    ? r.collapse()
                                    : r.expand();
                        },
                        !1,
        ...
        (z.prototype.query = function (t) {
            ...
            if (this.lastQuery !== t || !this.els.result.firstChild) {
                (this.lastQuery = t),
                    this.clearResults(),
                    P(this.els.reset, H.spin);
                var s = { url: e.url, data: e.params };
                e.callbackName &&
                    ((s.jsonp = !0), (s.callbackName = e.callbackName)),
                    $(s)
                        .then(function (t) {
                            n.options.debug && console.info(t),
        ...
        (z.prototype.createList = function (t) {
            ...
            t.forEach(function (e) {
                ...
                t.addEventListener(
                    ...
                    function (t) {
                        t.preventDefault(),
                            s.chosen(e, n, e.address, e.original);
                    },
                    !1,
                ),
                    r.appendChild(t);
        ...
        (z.prototype.addressTemplate = function (t) {
            ...
            return (
                t.name &&
                    e.push(
                        ['<span class="', H.road, '">{name}</span>'].join(''),
                    ),
